...
fun SimonIntroScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Obserwuj sekwencję kolorów i dźwięków, a następnie powtórz ją we właściwej kolejności. Jeśli się pomylisz, możesz spróbować ponownie.",
